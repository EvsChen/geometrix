...
void AstoneBuff::BeginPlay()
{
	Super::BeginPlay();
	OnActorHit.AddDynamic(this, &AstoneBuff::onHit);
...
// Called every frame
void AstoneBuff::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);
}


void AstoneBuff::onHit(AActor* SelfActor, class AActor* OtherActor, FVector NormalImpulse,
